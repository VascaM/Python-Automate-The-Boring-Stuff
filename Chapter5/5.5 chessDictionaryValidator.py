...
#If the chess was valid its print True otherwise it will print False
...
print(validate_board({'a1':'bking','a2':'wking','h1':'bpawn','h2':'bpawn','h3':'bpawn','h4':'bpawn','h5':'bpawn','h6':'bpawn','h7':'bpawn','h8':'bpawn','g7':'bpawn'}))#False theres more than 8 pawns
